...
type Querier interface {
	...
	CreateOffenseType(ctx context.Context, arg CreateOffenseTypeParams) (OffenseType, error)
	CreatePayment(ctx context.Context, arg CreatePaymentParams) (Payment, error)
	CreateTipJar(ctx context.Context, arg CreateTipJarParams) (TipJar, error)
	CreateUser(ctx context.Context, arg CreateUserParams) (User, error)
	DeactivateOffenseType(ctx context.Context, id int32) (OffenseType, error)
	...
	GetOffenseType(ctx context.Context, id int32) (OffenseType, error)
	...
	ListAllOffenseTypesForJar(ctx context.Context, jarID int32) ([]OffenseType, error)
	ListJarMembers(ctx context.Context, jarID int32) ([]ListJarMembersRow, error)
	ListOffenseTypesForJar(ctx context.Context, jarID int32) ([]OffenseType, error)
	...
	UpdateOffenseType(ctx context.Context, arg UpdateOffenseTypeParams) (OffenseType, error)
